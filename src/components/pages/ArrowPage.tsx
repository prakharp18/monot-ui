...
import { arrowHTML, arrowCSS, arrowJS, arrowFull } from '@/components/code/arrow-code'
    ...
    <div className="min-h-screen bg-black text-white px-6 py-24 font-sans flex flex-col items-center gap-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-zinc-400 text-sm max-w-sm mx-auto">
          Continuous directional flow with a fading trail. Indicates forward motion without interruption.
        </p>
      </div>
      ...
      <div className="w-full max-w-2xl space-y-4">
        ...
        <CodeBlock tabs={[
          { label: 'Full Example', code: arrowFull },
          { label: 'HTML', code: arrowHTML },
          { label: 'CSS', code: arrowCSS },
          { label: 'JS', code: arrowJS },
        ]} />
      </div>
    </div>
  )
