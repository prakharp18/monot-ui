...
import { AsciiArrow } from '@/components/ascii/AsciiArrow'
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center gap-10 p-8 font-sans">
      ...
      <div className="text-center">
        <h1 className="font-mono text-sm tracking-[0.3em] uppercase text-white mb-2">Moving Arrow</h1>
        <p className="text-zinc-400 text-xs tracking-wide max-w-xs">Continuous directional flow with a fading trail. Indicates forward motion without interruption.</p>
      </div>
      <div className="w-80 h-32 border border-white/20 rounded-2xl overflow-hidden"><AsciiArrow /></div>
