...
import { stabilizeHTML, stabilizeCSS, stabilizeJS, stabilizeFull } from '@/components/code/stabilize-code'
    ...
    <div className="min-h-screen bg-black text-white px-6 py-24 font-sans flex flex-col items-center gap-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-zinc-400 text-sm max-w-sm mx-auto">
          A waveform settling into a stable state. Represents calibration, balancing, or system stabilization.
        </p>
      </div>
      ...
      <div className="w-full max-w-lg">
        <CodeBlock
          tabs={[
            { label: 'Full Example', code: stabilizeFull },
            { label: 'HTML', code: stabilizeHTML },
            { label: 'CSS', code: stabilizeCSS },
            { label: 'JS', code: stabilizeJS },
          ]}
        />
      </div>
