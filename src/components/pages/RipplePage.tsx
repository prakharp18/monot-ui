...
import { rippleHTML, rippleCSS, rippleJS, rippleFull } from '@/components/code/ripple-code'
    ...
    <div className="min-h-screen bg-black text-white px-6 py-24 font-sans flex flex-col items-center gap-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-zinc-400 text-sm max-w-sm mx-auto">
          Expands outward then resets. A gentle emitter for signals, broadcasts, or interaction feedback.
        </p>
      </div>
      ...
      <div className="w-full max-w-lg">
        <CodeBlock
          tabs={[
            { label: 'Full Example', code: rippleFull },
            { label: 'HTML', code: rippleHTML },
            { label: 'CSS', code: rippleCSS },
            { label: 'JS', code: rippleJS },
          ]}
        />
      </div>
