...
import { beamHTML, beamCSS, beamJS, beamFull } from '@/components/code/beam-code'
  ...
  return (
    <div className="min-h-screen bg-black text-white px-6 py-24 font-sans flex flex-col items-center gap-12">
      ...
      <div className="w-full max-w-2xl space-y-4">
        ...
        <CodeBlock tabs={[
          { label: 'Full Example', code: beamFull },
          { label: 'HTML', code: beamHTML },
          { label: 'CSS', code: beamCSS },
          { label: 'JS', code: beamJS },
        ]} />
      </div>
    </div>
  )
