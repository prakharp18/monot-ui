...
import { sparkHTML, sparkCSS, sparkJS, sparkFull } from '@/components/code/spark-code'
    ...
    <div className="min-h-screen bg-black text-white px-6 py-24 font-sans flex flex-col items-center gap-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-zinc-400 text-sm max-w-sm mx-auto">
          Small burst of characters. Represents thinking, idea generation, or AI response activation.
        </p>
      </div>
      ...
      <div className="w-full max-w-lg">
        <CodeBlock
          tabs={[
            { label: 'Full Example', code: sparkFull },
            { label: 'HTML', code: sparkHTML },
            { label: 'CSS', code: sparkCSS },
            { label: 'JS', code: sparkJS },
          ]}
        />
      </div>
