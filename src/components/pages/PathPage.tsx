...
import { AsciiPath } from '@/components/ascii/AsciiPath'
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center gap-10 p-8 font-sans">
      ...
      <div className="text-center">
        <h1 className="font-mono text-sm tracking-[0.3em] uppercase text-white mb-2">Path Tracer</h1>
        <p className="text-zinc-400 text-xs tracking-wide max-w-xs">Progressive route drawing. Ideal for loading states, navigation steps, or workflow planning.</p>
      </div>
      <div className="w-64 h-24 border border-white/20 rounded-2xl overflow-hidden"><AsciiPath /></div>
