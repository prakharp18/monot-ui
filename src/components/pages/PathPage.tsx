...
import { pathHTML, pathCSS, pathJS, pathFull } from '@/components/code/path-code'
    ...
    <div className="min-h-screen bg-black text-white px-6 py-24 font-sans flex flex-col items-center gap-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-zinc-400 text-sm max-w-sm mx-auto">
          Progressive route drawing. Ideal for loading states, navigation steps, or workflow planning.
        </p>
      </div>
      ...
      <div className="w-full max-w-2xl space-y-4">
        ...
        <CodeBlock tabs={[
          { label: 'Full Example', code: pathFull },
          { label: 'HTML', code: pathHTML },
          { label: 'CSS', code: pathCSS },
          { label: 'JS', code: pathJS },
        ]} />
      </div>
    </div>
  )
