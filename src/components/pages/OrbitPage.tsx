  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center gap-10 p-8 font-sans">
      ...
      <div className="text-center">
        <h1 className="font-mono text-sm tracking-[0.3em] uppercase text-white mb-2">Orbit</h1>
        <p className="text-zinc-400 text-xs tracking-wide max-w-xs">A single dot circling a center point. Represents an active system or continuous background process.</p>
      </div>
      <div className="w-64 h-64 border border-white/20 rounded-2xl overflow-hidden"><AsciiOrbit /></div>
