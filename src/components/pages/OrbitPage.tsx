...
import { orbitHTML, orbitCSS, orbitJS, orbitFull } from '@/components/code/orbit-code'
    ...
    <div className="min-h-screen bg-black text-white px-6 py-24 font-sans flex flex-col items-center gap-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-zinc-400 text-sm max-w-sm mx-auto">
          A single dot circling a center point. Represents an active system or continuous background process.
        </p>
      </div>
      ...
      <div className="w-full max-w-lg">
        <CodeBlock
          tabs={[
            { label: 'Full Example', code: orbitFull },
            { label: 'HTML', code: orbitHTML },
            { label: 'CSS', code: orbitCSS },
            { label: 'JS', code: orbitJS },
          ]}
        />
      </div>
